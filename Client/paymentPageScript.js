...
let displayCreditDetailsForm = () => {
  document.getElementById('customerDetailsSeperator').style.visibility =
    'visible';
};
let myWindow;
let redirectToPaypal = () => {
  ...
  myWindow.document.write(
    "<div style='height: 100%; display: flex; justify-content: center; align-items: center'><img src = '../assets/pay_pal_logo.png' style='width: 50%;' alt='PayPal'/></div>"
  );
  document.getElementById('customerDetailsSeperator').style.visibility =
    'hidden';
};
...
let redirectToMobilepay = () => {
  ...
  myWindow = popupCenter({ url: '', title: null, w: 400, h: 600 });
  myWindow.document.write(
    "<style>body{background-color: #5875fa}</style><div style='height: 100%; display: flex; justify-content: center; align-items: center'><img src = '../assets/mobile_pay_logo.png' style='width: 50%;' alt='MobilePay'/></div>"
  );
  document.getElementById('customerDetailsSeperator').style.visibility =
    'hidden';
};
